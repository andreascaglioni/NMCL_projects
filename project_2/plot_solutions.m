...
figure
subplot(2,1,1);
plot(ccRef(1:end-1), XhRef(:,1), cc001(1:end-1), Xh001(:,1), cc0005(1:end-1), Xh0005(:,1), ccRef(1:end-1), hExa(ccRef(1:end-1)));
...
set(gca,'FontSize',16);
subplot(2,1,2);
plot(ccRef(1:end-1), XhRef(:,2), cc001(1:end-1), Xh001(:,2), cc0005(1:end-1), Xh0005(:,2), ccRef(1:end-1), mExa(ccRef(1:end-1)));
legend( 'dx=0.00125', 'dx=0.01', 'dx=0.005', 'Exact solution');
grid on;
title 'Discharge';
set(gca,'FontSize',16);
